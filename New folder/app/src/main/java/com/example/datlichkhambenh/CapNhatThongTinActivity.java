...
public class CapNhatThongTinActivity extends AppCompatActivity {
    ...
    private TextInputLayout tilUsername, tilHoTen, tilMail, tilBirthday, tilAge, tilPhone, tilTiensu, tilMau;
    ...
    private void showAllUserData(String username) {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String tiensuFromDB = dataSnapshot.child("tiensu").getValue(String.class);
                String mauFromDB = dataSnapshot.child("mau").getValue(String.class);
                ...
                tilTiensu.getEditText().setText(tiensuFromDB);
                tilMau.getEditText().setText(mauFromDB);
    ...
    private void updateInfor() {
        findViewById(R.id.btn_ok_capNhatActivity).setOnClickListener(v -> {
            ...
            if(checkError){
                ...
                reference.child("tiensu").setValue(tilTiensu.getEditText().getText().toString().trim());
                reference.child("mau").setValue(tilMau.getEditText().getText().toString().trim());
    ...
    private void mappingView() {
        ...
        tilTiensu = findViewById(R.id.til_Tieusu_capNhatActivity);
        tilMau = findViewById(R.id.til_Mau_capNhatActivity);
    }
